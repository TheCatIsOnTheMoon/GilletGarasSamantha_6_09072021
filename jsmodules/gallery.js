        ...
        function createImage() {
            photographeGalleryDOM += `
                    ...
                    <figure class="gallery-card gallery-photo">
                        <img src="img/${media.photographerId}/${media.image}" class="lightbox-link" alt="photo nommée: ${media.alt}" id="${media.id}" tabindex="0"/>
        ...
        function createVideo() {
            photographeGalleryDOM += `
                    ...
                    <figure class="gallery-card gallery-photo" id="${media.id}">
                        <video class="lightbox-link" src="img/${media.photographerId}/${media.video}" alt="vidéo nommée: ${media.alt}" id="${media.id}" tabindex="0">
                            <source src="img/${media.photographerId}/${media.video}" type="video/mp4" alt="vidéo nommée: ${media.alt}">
