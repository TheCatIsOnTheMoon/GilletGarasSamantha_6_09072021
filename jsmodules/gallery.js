        ...
        function createImage() {
            photographeGalleryDOM += `
                    ...
                    <figure class="gallery-card gallery-photo">
                        <img src="img/${media.photographerId}/${media.image}" class="lightbox-link" alt="${media.alt}" id="${media.id}" tabindex="0"/>
            ...
            photographeGalleryDOM += `
                    ...
                    <figure class="gallery-card gallery-photo" id="${media.id}">
                        <video class="lightbox-link" src="img/${media.photographerId}/${media.video}" alt="${media.alt}" id="${media.id}" tabindex="0">
                            <source src="img/${media.photographerId}/${media.video}" type="video/mp4" alt="${media.alt}">
